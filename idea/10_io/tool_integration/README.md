...
- [idea/capture_ingest/](../capture_ingest/) — 統合は capture チャネルの一種でもある
- [idea/export_publish/](../export_publish/) — H5 LaTeX は export_publish の B1 と重複領域
- [idea/collaboration/](../collaboration/) — H7 Notion/Linear/Jira はチーム協働ツール群
- [idea/cross_device/](../cross_device/) — 統合は別デバイス／別アプリへの橋
- [idea/automation_obstacles/](../automation_obstacles/) — 「同期失敗」「ID衝突」「権限切れ」等の障害群
