...
- **TODO 正本**: [dev-docs/06_Operations/Todo_Pool.md](dev-docs/06_Operations/Todo_Pool.md) — P1 として登録済
- **Core Principles**: [dev-docs/](dev-docs/) — 原則 0（科学研究）、2（scope）、1（オフライン）が本 PJ の論拠
