...
- `dev-docs/03_Spec/AI_Integration.md` — AI 連携フェーズ定義
- `dev-docs/03_Spec/AI_Common_API.md` — 共通 API 契約
- `dev-docs/03_Spec/AI_Use_Cases.md` — ユースケースシナリオ集
- `dev-docs/ideas/260402subagent.md` — MCP vs 直接連携の比較
- `dev-docs/ideas/tree_compatible_language.md` — TCL 仕様
- `dev-docs/ideas/260410_scalable_knowledge_base_vision.md` — M3E ビジョン
