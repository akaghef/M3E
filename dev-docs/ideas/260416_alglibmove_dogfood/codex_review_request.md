...
詳細は [dev-docs/projects/AlgLibMove/plan.md](../dev-docs/projects/AlgLibMove/plan.md)。
...
- Phase A (12 facets / ~700 map nodes) と Phase B (debt_register / scalar_type_decision / open_problems) は [dev-docs/projects/AlgLibMove/](../dev-docs/projects/AlgLibMove/) に既存
