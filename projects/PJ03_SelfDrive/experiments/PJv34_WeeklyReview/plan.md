...
- 2026-04-29: ループを `init -> load_projects -> build_context -> generate_report -> write_artifacts -> done` の State/Node 構造へ分割し、`tmp/weekly-review-trace-latest.json` を出力するようにした。
