...
本 PJ は **4-view runtime** を使う（自走ハーネス PJ のため Evaluation Board を含む）。
...
| **Active Workspace** | `pj03/workspace` | friction 観察・harness 設計・実装のドリルダウン先 |
...
pool して後回しにしてよい。harness 本体の進行を止めるな。
