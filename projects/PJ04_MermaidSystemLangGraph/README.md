...
PJ04 の System Scope は、処理遷移である **Control Graph** と、State / Channel / Reducer / Resource Binding を束ねる **State Contract** を分けて扱う。
`Data Automaton` という独自語は使わず、LangGraph の State / Channel / Checkpoint に寄せる。
