...
- `docs/ideas/00_topic_pool.md` の組み合わせ高効果ペア「J1 + 03 Status mode」を基盤前提に
- `docs/ideas/keyboard_modes/` Status mode（テンキー操作）が SRS 復習 UI と相性
- `docs/ideas/slideshow/` Guided Tour は J4 質問駆動の「問い順序」と接続可能
