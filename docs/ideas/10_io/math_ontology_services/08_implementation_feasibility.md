...
[01_landscape.md](01_landscape.md) / [Axes.md](../../../01_Vision/Axes.md) / [Glossary](../../../00_Home/Glossary.md) より:
...
- [docs/ideas/30_ux/keyboard_modes/](../../30_ux/keyboard_modes/) のキーバインド方針と整合
...
- 大規模（PFR は数百ノード、Stacks は数千）で viewer 側のパフォーマンス懸念
  → [docs/ideas/40_data/performance_scale/](../../40_data/performance_scale/) と接続
...
- kind フィルタは [docs/ideas/30_ux/keyboard_modes/](../../30_ux/keyboard_modes/) の「モード」概念の拡張として自然に馴染む
- [docs/ideas/40_data/maintenance_hygiene/](../../40_data/maintenance_hygiene/) の重複検出（D1）と semantic kind は相性良 — 同じ対象に複数の kind エッジが刺さる整理で検出材料が増える
