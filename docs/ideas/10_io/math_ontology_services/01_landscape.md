...
本ブレストで並べる外部サービスは、M3E の **帯域進化軸**（[docs/01_Vision/Axes.md](../../../01_Vision/Axes.md)）のどこに接続するかで意味が変わる。
...
Glossary（[docs/00_Home/Glossary.md](../../../00_Home/Glossary.md)）の通り、M3E は既に帯域に応じた二つの関係種を持つ:
