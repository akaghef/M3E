...
> メタフォルダ: `docs/ideas/10_io/` — 外部の知識サービス群を M3E に取り込む／接続する可能性を俯瞰するため。
...
- [docs/ideas/10_io/tool_integration/](../tool_integration/) — 一般的な既存ツール統合
- [docs/ideas/10_io/capture_ingest/](../capture_ingest/) — A3 PDF 取り込み、A8 AI 対話取り込みと接続
- [docs/ideas/10_io/export_publish/](../export_publish/) — B1 論文ドラフト自動生成、B8 知識グラフ標準形式
- [docs/ideas/20_ai/ai_agent_deep/](../../20_ai/ai_agent_deep/) — C6 research assistant フロー
