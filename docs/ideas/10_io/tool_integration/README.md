...
- [docs/ideas/10_io/capture_ingest/](../capture_ingest/) — 統合は capture チャネルの一種でもある
- [docs/ideas/10_io/export_publish/](../export_publish/) — H5 LaTeX は export_publish の B1 と重複領域
- [docs/ideas/50_collab/collaboration/](../../50_collab/collaboration/) — H7 Notion/Linear/Jira はチーム協働ツール群
- [docs/ideas/50_collab/cross_device/](../../50_collab/cross_device/) — 統合は別デバイス／別アプリへの橋
- [docs/ideas/00_meta/automation_obstacles/](../../00_meta/automation_obstacles/) — 「同期失敗」「ID衝突」「権限切れ」等の障害群
- [docs/ideas/00_topic_pool.md](../../00_topic_pool.md) — 元プール（H カテゴリ）
