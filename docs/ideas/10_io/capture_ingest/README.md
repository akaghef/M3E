...
- 既存 docs/ideas/ ブレスト（slideshow / keyboard_modes / map_views / automation_obstacles）と接続
...
## 関連 docs/ideas/ クロスリンク

- `docs/ideas/keyboard_modes/05_capture_navigation.md` — Capture mode のキー設計
- `docs/ideas/keyboard_modes/09_numpad_quick_input.md` — テンキー高速入力
- `docs/ideas/automation_obstacles/` — 自動化の限界と「人間が触る」ライン
- `docs/ideas/slideshow/` — 取り込んだ素材の出力経路（双対）
- `docs/ideas/map_views/` — capture 直後の表示ビュー候補
- `docs/ideas/00_topic_pool.md` — A セクション（A1-A10）が本ブレストの起点
