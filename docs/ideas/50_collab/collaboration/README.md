...
- `docs/ideas/automation_obstacles/05_m3e_strategy.md` — NM4 / F1〜F5 / 役割1ハブ
- `docs/ideas/capture_ingest/README.md` — 取り込み後の triage を協調レビューに繋ぐ
- `docs/ideas/keyboard_modes/` — Review mode / Comment mode のキー設計余地
- `docs/ideas/map_views/` — Presence view / Review queue view の候補
- `docs/ideas/00_topic_pool.md` — E1-E7（本ブレストの起点）
