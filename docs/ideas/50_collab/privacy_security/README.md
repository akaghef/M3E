...
- 既存 docs/ideas/（capture_ingest L1-L4, automation_obstacles）と接続
...
- `docs/ideas/capture_ingest/05_data_privacy.md` — capture チャネルでの privacy 論点（L1-L4）
- `docs/ideas/automation_obstacles/05_m3e_strategy.md` — ローカルファースト・vault 同期の戦略
- `docs/ideas/ai_agent_deep/` — AI 統合と privacy の交点（Mk5-Mk8 と直結）
- `docs/ideas/00_topic_pool.md` — L セクション（L1-L6）が本ブレストの起点
