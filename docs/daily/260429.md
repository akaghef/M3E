...
- `docs/ideas/00_meta/display_contracts/05_implementation_contract.md` を追加し、実装 facet の depth / breadth / link / anchor / color / collapse 契約を固定した。
- `docs/ideas/00_meta/display_contracts/06_timeseries_contract.md` を追加し、timeseries facet の `depth=time` / `breadth=co-temporal events` 契約を固定した。
