...
| 文書 | パス | 読むタイミング |
|------|------|--------------|
| MVC & Command | `docs/04_Architecture/MVC_and_Command.md` | Model/View/Controller の責務境界やCommand パターンに関わる変更 |
| AI Infrastructure | `docs/04_Architecture/AI_Infrastructure.md` | LLM連携、サブエージェント、Gateway設計 |
| Worktree Separation | `docs/00_Home/Worktree_Separation_Rules.md` | ブランチ・worktree 運用の確認 |
