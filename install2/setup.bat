...
REM ============================================================
REM  M3E Setup v2 (install2)
REM  - Keeps legacy install/ untouched
...
if exist "%NODE_EXE%" (
  call :log " Portable Node.js found in install2\node."
  goto :node_ready
)
...
call :log " Node.js %NODE_VERSION% installed to install2\node\"
...
> "%LOG_FILE%" echo [%date% %time%] M3E setup v2 log start
exit /b 0
