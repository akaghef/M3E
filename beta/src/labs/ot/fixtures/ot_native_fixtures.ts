export const OT_NATIVE_FIXTURES = {
  agents: [
    ...
    { name: "Marie Curie", category: "agent", running: false, attached: false, cmd: "zsh", live: "", model: "fixture-model", provider: "openai", ctx_used: null, act_state: "", task: "Finished fixture task", deliv: 1 },
  ],
  messages: [
  ...
  graph: {
    nodes: ["Ada Lovelace", "Alan Turing", "Marie Curie"],
