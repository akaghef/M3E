...
Legacy readers may still enter through `protocols/map-manager.md`, but new
rules belong here.
...
- Write contract: `protocols/map-write-protocol.md`
- Scope contract: `protocols/scope-operation-protocol.md`
